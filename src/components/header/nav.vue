    ...
    <div class="m-nav">
        <ul class="nav">
            <li class="list"> 
                ...
                <dl>
                    <dd v-for="(item,index)  in listMenu" :key="index">
                        <router-link :to="{ name:'list',params:{name:item}}">{{ item }}</router-link>
                    </dd>
                </dl>
            </li>
            <li>
            ...
            <li class="list bd">
                <router-link to='/'>商家中心</router-link>
                   <dl >
                    ...
                    <dd>
                        <router-link to="/">美团智能收银</router-link></router-link>
                    </dd>
                    <dd>
            ...
            <li class="list site">
                ...
                <div class="subContainer">
                    ...
                    <dd>
                        <router-link to="/">火车票</router-link></router-link>
                    </dd>
                    <dd>
                        <router-link to="/">糖果名宿</router-link>
                    </dd>
                    <dd>
                    ...
                    <dd>
                        <router-link to="/">特色小吃</router-link></router-link>
                    </dd>
                    <dd>
                    ...
                    <dd>
                        <router-link to="/">热映电影</router-link></router-link>
                    </dd>
                    <dd>
